...
describe("Package", () => {
    it.each([
        ...
        [{ name: "jest" }, { name: "jest", isDev: false, devOnly: false }],
        [
            { name: "jest", devOnly: true },
            { name: "jest", isDev: true, devOnly: true },
        ],
        [
            { name: "jest", devOnly: false },
            { name: "jest", isDev: false, devOnly: false },
        ],
        [
            { name: "jest", isDev: true },
            { name: "jest", isDev: true, devOnly: false },
        ],
        [
            { name: "jest", isDev: true, devOnly: false },
            { name: "jest", isDev: true, devOnly: false },
